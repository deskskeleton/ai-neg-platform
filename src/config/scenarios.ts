...
const ROUND_THEME_V1A: RoundTheme = {
  ...
  briefings: {
    roleA: {
      ...
      confidential: `Your point values (DO NOT SHARE):
        • Deadline Strictness: Flexible = 8pts, Standard = 28pts, Strict = 52pts
        • Written Work: You write most = 18pts, Even = 45pts, They write most = 47pts
        • Presentation: Specialist presents = 62pts, Shared = 37pts, You present = 21pts
        • Grading Scheme: Group-heavy = 39pts, Balanced = 31pts, Individual-heavy = 22pts
    ...
    roleB: {
      ...
      confidential: `Your point values (DO NOT SHARE):
        • Deadline Strictness: Flexible = 62pts, Standard = 36pts, Strict = 18pts
        • Written Work: Coord writes most = 48pts, Even = 34pts, You write most = 12pts
        • Presentation: You present = 12pts, Shared = 33pts, Coord presents = 55pts
        • Grading Scheme: Group-heavy = 35pts, Balanced = 27pts, Individual-heavy = 18pts
...
const ROUND_THEME_V1B: RoundTheme = {
  ...
  issueLabels: [
    ...
    { label: 'Length of Stay Commitment', description: 'Minimum period the tenant commits to staying',
      options: ['Short-term (3 months)', 'Medium-term (6 months)', 'Long-term (12 months)'] },
  ...
  briefings: {
    roleA: {
      ...
      confidential: `Your point values (DO NOT SHARE):
        • Rent Contribution: Tenant pays less = 10pts, Even = 30pts, Tenant pays more = 50pts
        • Length of Stay: Short-term = 60pts, Medium-term = 35pts, Long-term = 15pts
        • Furnishing: Tenant furnishes = 55pts, Shared = 30pts, You furnish = 15pts
        • Utility Split: Fixed = 25pts, Usage-based = 35pts, Equal = 10pts
    ...
    roleB: {
      ...
      confidential: `Your point values (DO NOT SHARE):
        • Rent Contribution: You pay less = 60pts, Even = 35pts, You pay more = 15pts
        • Length of Stay: Short-term = 10pts, Medium-term = 30pts, Long-term = 50pts
        • Furnishing: You furnish = 15pts, Shared = 30pts, Lease holder furnishes = 55pts
        • Utility Split: Fixed = 20pts, Usage-based = 35pts, Equal = 15pts
...
const ROUND_THEME_V1C: RoundTheme = {
  ...
  issueLabels: [
    { label: 'Budget Allocation', description: 'How the limited funds are divided between teams',
      options: ['Events-heavy (60/40)', 'Balanced (50/50)', 'Comms-heavy (40/60)'] },
    { label: 'Volunteer Time Allocation', description: 'Which activities volunteers prioritize',
      options: ['Events priority', 'Shared equally', 'Comms priority'] },
    { label: 'Visibility & Credit', description: 'Who gets recognition for organization success',
      options: ['Comms lead highlighted', 'Joint credit', 'Events lead highlighted'] },
  ...
  briefings: {
    roleA: {
      ...
      confidential: `Your point values (DO NOT SHARE):
        • Budget Allocation: Events-heavy = 12pts, Balanced = 34pts, Comms-heavy = 54pts
        • Volunteer Time: Events priority = 20pts, Shared = 45pts, Comms priority = 52pts
        • Visibility & Credit: Comms lead = 58pts, Joint = 32pts, Events lead = 10pts
        • Decision Autonomy: Joint = 36pts, Mixed = 30pts, Independent = 14pts
    ...
    roleB: {
      ...
      confidential: `Your point values (DO NOT SHARE):
        • Budget Allocation: Events-heavy = 60pts, Balanced = 28pts, Comms-heavy = 12pts
        • Volunteer Time: Events priority = 18pts, Shared = 50pts, Comms priority = 32pts
        • Visibility & Credit: Comms lead = 12pts, Joint = 34pts, Events lead = 54pts
        • Decision Autonomy: Joint = 28pts, Mixed = 36pts, Independent = 16pts
